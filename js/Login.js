...
const validarCampo = (expresion, input, campo) => {
	if(expresion.test(input.value)){
		...
		document.getElementById(`group__${campo}`).classList.add('login-form__group-correcto');
		...
		document.getElementById(`group__${campo}`).classList.remove('login-form__group-correcto');
...
const validarPassword2 = () => {
	...
	if(inputPassword1.value !== inputPassword2.value){
		...
		document.getElementById(`group RepeatPass`).classList.remove('login-form__group-correcto');
		...
		document.getElementById(`group__RepeatPass`).classList.add('login-form__group-correcto');
